...
CREATE  INDEX I_FK_EVALUATION_SYNTHESE_ETAPE
     ON EVALUATION_SYNTHESE (idETAPE ASC);
...
CREATE TABLE IF NOT EXISTS QUESTION_SYNTHESE
 (
   id INTEGER(2) NOT NULL  ,
   idTHEME_SYNTHESE INTEGER(2) NOT NULL  ,
...
CREATE  INDEX I_FK_QUESTION_SYNTHESE_THEME_SYNTHESE
     ON QUESTION_SYNTHESE (idTHEME_SYNTHESE ASC);
...
CREATE TABLE IF NOT EXISTS OBJECTIF
 (
   id BIGINT(4) NOT NULL  ,
   idCATEGORIE_I_O SMALLINT(1) NULL  ,
   idETAPE INTEGER(2) NOT NULL  ,
...
CREATE  INDEX I_FK_OBJECTIF_CATEGORIE_I_O
     ON OBJECTIF (idCATEGORIE_I_O ASC);
...
CREATE TABLE IF NOT EXISTS REPONSE
 (
   idQUESTION_SYNTHESE INTEGER(2) NOT NULL  ,
   idELEVE BIGINT(4) NOT NULL  ,
...
CREATE  INDEX I_FK_REPONSE_QUESTION_SYNTHESE
     ON REPONSE (idQUESTION_SYNTHESE ASC);
...
ALTER TABLE EVALUATION_SYNTHESE 
  ADD FOREIGN KEY FK_EVALUATION_SYNTHESE_ETAPE (idETAPE)
      REFERENCES ETAPE (id) ;


ALTER TABLE THEME_SYNTHESE 
  ADD FOREIGN KEY FK_THEME_SYNTHESE_ETAPE (idETAPE)
      REFERENCES ETAPE (id) ;
...
ALTER TABLE QUESTION_SYNTHESE 
  ADD FOREIGN KEY FK_QUESTION_SYNTHESE_THEME_SYNTHESE (idTHEME_SYNTHESE)
      REFERENCES THEME_SYNTHESE (id) ;


ALTER TABLE OBJECTIF 
  ADD FOREIGN KEY FK_OBJECTIF_CATEGORIE_I_O (idCATEGORIE_I_O)
...
ALTER TABLE REPONSE 
  ADD FOREIGN KEY FK_REPONSE_QUESTION_SYNTHESE (idQUESTION_SYNTHESE)
      REFERENCES QUESTION_SYNTHESE (id) ;
...
ALTER TABLE PASSER 
  ADD FOREIGN KEY FK_PASSER_EVALUATION_SYNTHESE (idSYNTHESE)
      REFERENCES EVALUATION_SYNTHESE (id) ;
