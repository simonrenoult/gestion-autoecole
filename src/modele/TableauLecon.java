...
/*
 * Cette classe permet de d'extraire les donn�es de la JTable (conversion d'un
 * tableau d'objet [][] en Liste KAssurerLecon). Cette liste va �tre ensuite
 * compar�e � la liste de r�f�rence KlisteRDVRef afin de voir ci des RDV ont �t�
 * modifi�. La table Agenda admet un id num�rique et non plus une date, donc les
 * on compare aussi les dates et heures de RDV entre ceux de la Jtable
 * KlisteAgendaGraphique et la liste de reference KlisteAgendaRef (par rapport �
 * un �l�ve). Cette necessit� de ces listes provient du fait qu'on ne renseigne
 ...
 * dans le champ grahique du 3eme RDV (3eme ligne de la Jtable), g�n�re un
 * message d'erreur.
 * 
 * TableauChampSaisieOk est un tableau de bool�en o� chaque champ d�termine si
 * le format des donn�es est valide en BDD.
 */
...
public class TableauLecon
{
	...
	/*
	 * Permet d'ins�rer un objet KAgenda � la table Agenda.
	 */
	...
	/*
	 * recupere la liste des dates et horaire des le�ons d'un �l�ve.
	 */
	...
	/*
	 * Creer la liste contenant toutes les cles primaires de Agenda non pr�sente
	 * dans la BDD
	 */
	 ...
	 * existant dans la BDD pour ce meme eleve. le point de d�part est donc
	 * KlisteRDVRef.count() pour recuperer juste les nouvelles le�ons.
	 */
	 ...
	 * BDD. Tout est alors stock� dans KlisteRDVRef.
	 */
	...
	/*
	 * Efface un RDV posterieur � la dateActuelle
	 */
	public boolean effacerRDVListe(KListObject<KAssurer_lecon> KlisteGraphique)
	{
		
		/*
		 * KlisteRef a �t� initialis� des le double clic sur un eleve. On va
		 * donc supprimer en BDD les RDV supprim� graphiquement si la date est
		 * post�rieur � la date actuelle (�viter la magouille).
		 */
		int index = 0; // le RDV de KlisteRef n'est pas present dans
						// KlisteGraphique : il a �t� supprim�.
		int i;
		int j;
		int cpt = 0;
	...
	public String messageRenvoyeeUI(int num)
	{
		...
		switch (num)
		{
			...
			case 2:
				return "-L'ensemble des RDV ont �t� enregistr�s en base de donn�es\n";
				
			case 1:
				return "";
				
			case -1:
				return "-La date de RDV fix�e ne peut pas �tre ant�rieur � la date actuelle\n";
			...
			case -4:
				return "-Les dates de RDV ne correpondent pas � un ordre chronologique.\n";
				
			case -5:
				return "-Une dur�e de le�on est invalide (expression absente ou format invalide).\n";
				
			case -6:
				return "-Un moniteur doit �tre selectionn� pour chaque RDV.\n";
				
			case -7:
				return "-Une date de RDV a �t� modifi� de fa�on invalide.\n";
				
			case -8:
				return "-Un horaire de le�on est invalide (expression absente ou format invalide).\n";
	...
	/*
	 * Creation d'un objet java.sql.TimeStamp � partir de java.sql.Date et
	 * java.sql.Ime
	 */
	@SuppressWarnings("deprecation")
	...
	/*
	 * Creer un temp au format SQL � partir d'un type String
	 */
	@SuppressWarnings("deprecation")
	...
	/*
	 * recuperation de l'id du moniteur � partir du tableau d'objet (pas moyen
	...
	public int recupererIdMoniteur(String chaine)
	{
		...
		return -1;// pour les tests, soit c'est bon, soit �a plante.
		
	}
	
	/*
	 * retourne le nombre de s�ance pratique de conduite
	 */
	...
	/*
	 * retourne le nombre d'heure pass� � l'auto�cole.
	 */
	...
	public KAssurer_lecon contrainteintegriteMoniteur(KListObject<KAssurer_lecon> KlisteGraphique)
	{
		...
		return new KAssurer_lecon();// On retourne un RDV vide, temoin que �a
									// s'est bien pass�.
	...
	public int contrainteintegriteEleve(KListObject<KAssurer_lecon> KlisteGraphique)
	{
		...
		for (i = 0; i < KlisteGraphique.count(); i++)
		{
			...
			{
				System.out.println("");
				return KlisteAgendaRef.count() + i;// numero de ligne o� �a
													// cloche.
			}
			
		}
		
		return -1; // L'eleve est disponible par rapport � tous ses RDV.
