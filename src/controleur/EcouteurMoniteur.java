...
public class EcouteurMoniteur implements MouseListener, ActionListener,DocumentListener {
	...
	public void mouseReleased(java.awt.event.MouseEvent e) {
		if(e.getSource() == f.getListeMoni() && e.getClickCount()==2) {
			...
			f.getNom().setText(prenom);
			f.getPrenom().setText(nom);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == f.getEffacer()) {
			...
			if((f.getNom().getText().equals(""))||(f.getPrenom().getText().equals("") )){new JOptionPane().showMessageDialog(null, "Un champ blanc ne peut �tre ins�r�", "Erreur",JOptionPane.ERROR_MESSAGE); }
	...
	//m�thode automatiquement g�n�r� par DocumentListener.
	@Override
