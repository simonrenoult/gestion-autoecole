...
public class KPasser extends KObject
{
	...
	{
		return " [eleve] = " + eleve + " [idELEVE] = " + idELEVE + " [RESULTAT] = " + RESULTAT
				+ " [DATE_PASSAGE_SYNTHESE] = " + DATE_PASSAGE_SYNTHESE + " [idSYNTHESE] = " + idSYNTHESE
				+ " [NB_H_TH] = " + NB_H_TH + " [synthese] = " + synthese;
	}
}