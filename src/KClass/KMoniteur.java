...
public KMoniteur() {
	...
	keyFields="id";
	tableName="moniteur";
	hasMany(KSuperviser.class);hasMany(KEleve.class);hasMany(KAssurer_lecon.class);
...
public String toString() {
	return " [eleves] = " + eleves+" [supervisers] = " + supervisers+" [NOM_MONITEUR] = " + NOM_MONITEUR+" [PRENOM_MONITEUR] = " + PRENOM_MONITEUR+" [assurer_lecons] = " + assurer_lecons;
}
}