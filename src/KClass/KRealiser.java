...
public class KRealiser extends KObject
{
	...
	{
		return " [eleve] = " + eleve + " [idELEVE] = " + idELEVE + " [idOBJECTIF] = " + idOBJECTIF
				+ " [DATE_REALISATION_OBJECTIF] = " + DATE_REALISATION_OBJECTIF + " [ETAT_OBJECTIF] = " + ETAT_OBJECTIF
				+ " [objectif] = " + objectif + " [OBSERVATION_OBJECTIF] = " + OBSERVATION_OBJECTIF;
	}
}