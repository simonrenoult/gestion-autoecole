...
private java.sql.Timestamp idAGENDA;
private String OBSERVATION_LECON;
public KAssurer_lecon() {
	super();
	keyFields="idAGENDA,idELEVE";
	tableName="assurer_lecon";
	//belongsTo(KMoniteur.class);belongsTo(KEleve.class);belongsTo(KAgenda.class);
...
public java.sql.Timestamp getIdAGENDA(){
...
public void setIdAGENDA(java.sql.Timestamp aIdAGENDA){
...
public String toString() {
	return " [eleve] = " + eleve+" [agenda] = " + agenda+" [DUREE_LECON] = " + DUREE_LECON+" [idELEVE] = " + idELEVE+" [idMONITEUR] = " + idMONITEUR+" [moniteur] = " + moniteur+" [idAGENDA] = " + idAGENDA+" [OBSERVATION_LECON] = " + OBSERVATION_LECON;
}
}