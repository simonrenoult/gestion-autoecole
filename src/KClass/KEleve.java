...
public KEleve() {
	...
	keyFields="id";
	tableName="eleve";
	belongsTo(KMoniteur.class);belongsTo(KFormation.class);hasMany(KSuperviser.class);hasMany(KReponse.class);hasMany(KRealiser.class);hasMany(KPasser.class);hasMany(KAssurer_lecon.class);
...
public String toString() {
	return " [passers] = " + passers+" [realisers] = " + realisers+" [supervisers] = " + supervisers+" [ADRESSE_ELEVE] = " + ADRESSE_ELEVE+" [CODE_POSTAL_ELEVE] = " + CODE_POSTAL_ELEVE+" [PROFESSION_ELEVE] = " + PROFESSION_ELEVE+" [MAIL_ELEVE] = " + MAIL_ELEVE+" [DATE_EVAL_ELEVE] = " + DATE_EVAL_ELEVE+" [VOLUME_HORAIRE_PRATIQUE_ELEVE] = " + VOLUME_HORAIRE_PRATIQUE_ELEVE+" [PHOTO_ELEVE] = " + PHOTO_ELEVE+" [moniteur] = " + moniteur+" [NOM_ELEVE] = " + NOM_ELEVE+" [formation] = " + formation+" [TEST_VU_ELEVE] = " + TEST_VU_ELEVE+" [OBSERVATION_VUE_ELEVE] = " + OBSERVATION_VUE_ELEVE+" [DATE_ENREGISTREMENT_ELEVE] = " + DATE_ENREGISTREMENT_ELEVE+" [PRENOM_ELEVE] = " + PRENOM_ELEVE+" [idMONITEUR] = " + idMONITEUR+" [reponses] = " + reponses+" [assurer_lecons] = " + assurer_lecons+" [TELEPHONE_ELEVE] = " + TELEPHONE_ELEVE+" [RESULTAT_ELEVE_ORAL] = " + RESULTAT_ELEVE_ORAL+" [DATE_INSCRIPTION_ELEVE] = " + DATE_INSCRIPTION_ELEVE+" [COMMUNE_ELEVE] = " + COMMUNE_ELEVE+" [idFORMATION] = " + idFORMATION+" [VOLUME_HORAIRE_TH_ELEVE] = " + VOLUME_HORAIRE_TH_ELEVE+" [LIVRET_NEPH_ELEVE] = " + LIVRET_NEPH_ELEVE+" [DATE_DE_NAISS_ELEVE] = " + DATE_DE_NAISS_ELEVE;
}
}