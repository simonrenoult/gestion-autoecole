...
public class FicheEleve extends JPanel
{
	...
	/*
	 * Rend tous les champs graphiques de type combobox blancs. et les autres
	 * types ???
	 */
	...
	/*
	 * Fonction principale pour g�n�rer le graphique this.
	 */
	...
	/*
	 * Permet de faire �couter les �lements gra phiques
	 */
	...
	/*
	 * On cr�� le panneau du test de la vue
	 */
	...
	/*
	 * On cr�� le panneau de renseignement tel que le num NEPH, liste moniteur,
	 * etc..
	 */
	...
	/*
	 * Permet de selectionner la date actuelle pour les couple de combobox
	 * (DD/MM/YYYY). Cette m�thode est commune aux 2 contr�leurs
	 * (EcouteurFicheEleve et EcouteurPrincipale) afin d'�viter la redondance de
	 * code (de cette fonction) dans ces derniers.
	 */
	public void parametrerJComboBoxDate(JComboBox j, JComboBox m, JComboBox a)
	{
		...
		for (int i = 1; i < 32; i++)
		{
			...
			if ((dateStandard.format(date).substring(0, 2).equals("0" + i + ""))
					|| (dateStandard.format(date).substring(0, 2).equals(i + "")))
	...
	/**
	 * @param containerSous1
	 *            the containerSous1 to set
	 */
	...
	/**
	 * @param containerSous2
	 *            the containerSous2 to set
	 */
	...
	/**
	 * @param containerEvaluaD
	 *            the containerEvaluaD to set
	 */
	...
	/**
	 * @param containerIdEleve
	 *            the containerIdEleve to set
	 */
	...
	/**
	 * @param containerIdEleveS1
	 *            the containerIdEleveS1 to set
	 */
	...
	/**
	 * @param containerIdEleveS2
	 *            the containerIdEleveS2 to set
	 */
	...
	/**
	 * @param containerTestVue
	 *            the containerTestVue to set
	 */
	...
	/**
	 * @param containerNumLivret
	 *            the containerNumLivret to set
	 */
	...
	/**
	 * @param containerResponsable
	 *            the containerResponsable to set
	 */
	 ...
	 */
	/*
	 * public JPanel getContainerTabForma() { return containerTabForma; }
	 * 
	 * /**
	 * 
	...
	/**
	 * @param responsableForma
	 *            the responsableForma to set
	 */
	 ...
	 */
	/*
	 * public void setBoutonAjouter(JButton boutonAjouter) { this.boutonAjouter
	 * = boutonAjouter; }
	 * 
	 * /**
	 * 
	...
	/**
	 * @param containertableauLecon
	 *            the containertableauLecon to set
	 */
