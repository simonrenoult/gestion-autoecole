...
/////////////////////////////////////////////////////////////////METHODES
	...
	private void DefinirEditeurCellule() {
		...
		//tableau.setDefaultEditor(Color.class,new vue.JTableAssurerLecon.ColorEditor());
	...
	public void initialiserJlabel() {
 		nombreHeurePratique.setText("Information : L'élève compte à ce jour "+tableauLecon.compterHeure()+" de leçons pratiques.");
