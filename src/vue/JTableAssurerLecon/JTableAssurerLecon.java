...
public class JTableAssurerLecon extends JPanel {
	...
	private TableauLecon tableauLecon =null;
	 ...
	 public JTableAssurerLecon(TableauLecon tableaulecon){
		...
		this.tableau = new JTable(JModel);		
		
		
		this.tableau.setRowHeight(30);
		this.tableau.getColumnModel().getColumn(0).setPreferredWidth(70);
		this.tableau.getColumnModel().getColumn(1).setPreferredWidth(50);
		this.tableau.getColumnModel().getColumn(2).setPreferredWidth(40);
		this.tableau.getColumnModel().getColumn(3).setPreferredWidth(150);
		this.tableau.getColumnModel().getColumn(4).setPreferredWidth(380);
		this.tableau.getColumnModel().getColumn(5).setPreferredWidth(120);
		
		
		//On définit l'éditeur par défaut pour la cellule 
		//en lui spécifiant quel type d'affichage prendre en compte
		this.tableau.getColumn("Moniteur").setCellEditor(new DefaultCellEditor(combo));
		DefaultTableCellRenderer dcr = new DefaultTableCellRenderer();
		this.tableau.getColumn("Moniteur").setCellRenderer(dcr);
 	...
 	public void initialiserJlabel() {
 		nombreHeurePratique.setText("Information : L'élève compte à ce jour "+tableauLecon.compterHeure()+" heures de leçons pratiques.");
 		nombreLecon.setText("Information : L'élève compte à ce jour "+tableauLecon.compterSeance()+" séances sur sa formation.");
	...
	/*private void recupererListeMoniteur() {
		...
		combo.setModel(new DefaultComboBoxModel(ListeMoniteur)); 
...
////////////////////////////////////////////////////////ACCESSEURS
	...
	/**
	 * @param JModel the JModel to set
	 */
	...
	/**
	 * @param correspondanceMoniteur the correspondanceMoniteur to set
	 */
	...
	/**
	 * @param nombreHeurePratique the nombreHeurePratique to set
	 */
	...
	/**
	 * @param nombreLecon the nombreLecon to set
	 */
