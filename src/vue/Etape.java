...
import controleur.EcouteurEtape;
import controleur.EcouteurMoniteur;
...
public class Etape extends JPanel {
	...
	public Etape(int numEtape){
		...
		// On enregistre le numero d'etape (commence a 1)
		this.numEtape = numEtape+1;
		
		// On cree l'ecouteur -> remplit les objectifs. TODO : enlever le commentaire pour enregistrer l'ecouteur
		/*EcouteurEtape ecouteur = */new EcouteurEtape(this.numEtape, this);

		this.setPreferredSize(new Dimension(900,670));
		
		texteTitre = new JLabel("ETAPE "+this.numEtape);
		texteTitre.setFont(new Font(null,Font.BOLD,20));
		texteTitre.setPreferredSize(new Dimension(800,30));
		
		JTabbedPane onglet = new JTabbedPane();
		JPanel partie1 = new JPanel();
		JPanel partie2 = new JPanel();
		partie1.setPreferredSize(new Dimension(880,610));
		partie2.setPreferredSize(new Dimension(880,610));
	   ...
	   /*// Anciennes valeurs
		...
		JLabel texteTitre2 = new JLabel("Fiche d'evaluation de synthese de l'etape "+this.numEtape);
	...
	/**
	 * Permet d'initialiser le tableau d'objectifs à la bonne taille
	 * @param size La taille du tableau (nombre d'objectifs dans l'etape).
	 */
	public void creerData1(int size){
		data1 = new Object[size][3];
	}
	...
	public void setData1(int i, int j, String valeur){
		data1[i][j] = valeur;
	}
