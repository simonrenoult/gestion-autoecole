...
public class FenetrePrincipale extends JFrame {
	...
	public FenetrePrincipale() {
		...
		/*
		 * TODO : remove comment to maximize window
		 * this.setExtendedState(Frame.MAXIMIZED_BOTH); setUndecorated(true);
		 */
	...
	// FIXME : rien à faire dans la vue !
	public void rechargerListeEleve() {
		...
		for (int i = 0; i < KListe.count(); i++) {
			listeEleves.add(KListe.get(i).getPRENOM_ELEVE().toLowerCase() + " "
					+ KListe.get(i).getNOM_ELEVE().toUpperCase());
		}
	...
	/*
	 * // Soit ça : public Etape getEtape(int i){ return etape[i-1]; }
	 */
