...
public class ExamenBlanc extends JPanel implements ActionListener
{
	...
	public ExamenBlanc()
	{
		...
		texteCode1 = new JLabel("<html>DEPART<br>"
				...
				+ "D2 : Demarrage en declivite.<hr>" + "ARRET<br>" + "A : Arret en circulation ou pour en sortir.<hr>"
				+ "LIGNE DROITE<br>" + "L1 : Agglomeration.<br>" + "L2 : Route.<br>"
				+ "L3 : Autoroute, route e chaussees separees (2x2 voies, etc.).<hr>" + "INTERSECTION<br>"
				+ "I1 : Feu tricolore.<br>" + "I2 : Stop.<br>" + "I3 : \"Cedez le passage\".<br>"
		...
		texteCode2 = new JLabel("<html>SENS GIRATOIRE<br>" + "G : Sens giratoire.<hr>" + "CHANGEMENT DE DIRECTION<br>"
				+ "C1 : A droite ou e gauche.<br>" + "C2 : Preselection (changement de voie).<br>"
				+ "C3 : Voie d'insertion ou de deceleration.<hr>" + "VIRAGE<br>" + "V : Virage.<hr>"
				+ "DEPASSEMENT<br>" + "DP1 : Depassement.<br>"
				+ "DP2 : Depassement d'un deux roues ou d'un pieton.<br>" + "DP3 : Etre depasse.<hr>"
				+ "CROISEMENT<br>" + "CR : Croisement<br><br><br></html>");
		texteCode2.setFont(new Font(null , Font.BOLD , 11));
		texteCode2.setPreferredSize(new Dimension(285 , 300));
		texteCode3 = new JLabel(
				"<html>DECLIVITE<br>"
						...
						+ "S5 : Circulation sur un \"parking\".<br>" + "S6 : Passage e niveau.<br>"
						+ "S7 : Ouvrage d'art, tunnel, pont.<br>" + "S8 : Zone de travaux.<br>"
	...
	class StateListener implements ActionListener
	{
		...
		{
			System.out.println("source : " + ((JRadioButton) e.getSource()).getText() + " - etat : "
